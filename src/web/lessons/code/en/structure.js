...
// Descriptions written as one-line strings
const plain = {
  return_policy: "Questions about returns",
  return_status: "Questions about a return",
};

// Descriptions split into what the option covers (what), what belongs to the neighboring option (not_for), and examples
const structured = {
  return_policy: {
